      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-12 form-group form-inline">
            ...
            <input type="text" class="form-control" id="by_invoice_number" placeholder="By Customer Name" onkeyup="searchInvoice(this.value, 'CUSTOMER_NAME');">
            &emsp;<input type="text" class="form-control" id="by_customer_name" placeholder="By Payment Type" onkeyup="searchInvoice(this.value, 'PAYMENT_STATUS');">
