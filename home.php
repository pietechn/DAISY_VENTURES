        ...
        <div class="row">
          <div class="row col col-xs-8 col-sm-8 col-md-8 col-lg-8">
            ...
            <?php
             ...
             createSection1('manage_medicine.php', 'Total Products', 'medicines');
              ...
              <table class="table table-bordered table-striped table-hover">
                <tbody>
                  ...
                  <tr>
                    <?php
                      $total = 0;
                      $query = "SELECT TOTAL_AMOUNT FROM invoices WHERE INVOICE_DATE = '$date'";
                      $result = mysqli_query($con, $query);
                    ...
                    ?>
                    <th>Total Sales</th>
                    <th class="text-success">N. <?php echo $total; ?></th>
                  </tr>
                  <tr>
                    <?php
                      //echo $date;
                    ...
                    <th class="text-danger">N. <?php echo $total; ?></th>
                  </tr>
                </tbody>
              </table>
            </div>
